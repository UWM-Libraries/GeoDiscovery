...
Rails.application.configure do
  ...
  # Keep expected rescued 404s from filling production logs with backtraces.
  ...
  # @TODO - Compress CSS and JS using a preprocessor.
  ...
  # config.active_job.queue_name_prefix = "GeoDiscovery_production"
  ...
  config.action_mailer.default_options = {
    from: ENV.fetch("ACTION_MAILER_FROM", %("AGSL GeoDiscovery" <noreply@uwm.edu>))
  }
